...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, func="evpi"))
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_cea, func="evpi"))
```
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_cea, inputs = inputs, pars="p1", func="evppi"))
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars=c("p1","p2"), func="evppi"))
```
or
```
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars=list("p1","p2"), func="evppi"))
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars=list("p1",c("p1","p2")), func="evppi"))
```
or
```
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_cea, inputs = inputs, pars=list("p1",c("p1","p2")), func="evppi"))
```
or
```
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", nsim=1000, func="evppi", method="gp"))
```
or
```
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", func="evppi", method="earth"))
```
or
```
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars=c("p1","p2"), gam_formula="s(p1) + s(p2)", func="evppi", method="gam"))
```
or
```
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", se=TRUE, B=100, func="evppi"))
```
or
```
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", etc = list(n.blocks=20), func="evppi", method="so"))
```
or
```
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", func="evppi", method="sal"))
```
or
```
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(model_fn = model_fn_nb, par_fn = par_fn, pars="p1", func="evppi_mc", ninner=1000, nouter=100))
```
or
```
...
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(model_fn = model_fn_nb, par_fn = par_fn_corr, pars="p1", func="evppi_mc", ninner=1000, nouter=100))
```
or
```
par_fn_corr <- function(n, p1=NULL){
...
set.seed(1)
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, datagen_fn = datagen_normal, n=c(10,100,1000), func="evsi"))
```
or
```
datagen_normal <- function(inputs, n=100, sd=1){
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", study = "normal_known", n=c(100,1000), func="evsi"))
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_cea, inputs = inputs, datagen_fn = datagen_normal, n=c(10,100,1000), func="evsi"))
```
or
```
...
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1", datagen_fn = datagen_normal, likelihood = likelihood_normal, n=100, func="evsi", method="is", nsim=1000))
```
or
```
likelihood_normal <- function(Y, inputs, n=100, sig=1){
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = outputs_nb, inputs = inputs, pars="p1",study = "normal_known", n=100, func="evsi", method="is", nsim=1000))
```
or
```
...
EVPPI is estimated here by *nonparametric regression* of the output on the input. Recall that the method of [Strong et al. (2013)](https://doi.org/10.1177/0272989X13505910) was used in `evppi` for models with decisions. [Jackson et al. 2019](https://doi.org/10.1080/01621459.2018.1562932) showed how this method applied in a wider class of problems, including models for estimation.
...
```
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = p2, inputs = inputs, study = "binary", pars = "p1", func="evsivar", n=c(100,1000,10000)))
```
or
```
...
model_run(model_name="voi", api_key=<your_api_key>, model_input = list(outputs = p2, inputs = inputs_p2, study = "binary", pars = "p1", func="evsivar", n=c(100,1000,10000)))
```
or
```
inputs_p2 = data.frame(p2 = p2)
